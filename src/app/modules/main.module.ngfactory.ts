...
import * as import17 from '../components/rim-search.service';
import * as import18 from '@angular/core/src/di/injector';
import * as import19 from '../components/rim-search.component.ngfactory';
import * as import20 from '@angular/core/src/application_tokens';
import * as import21 from '@angular/platform-browser/src/dom/events/dom_events';
import * as import22 from '@angular/platform-browser/src/dom/events/key_events';
...
class MainModuleInjector extends import0.NgModuleInjector<import1.MainModule> {
  ...
  __RimSearchService_28:import17.RimSearchService;
  constructor(parent:import18.Injector) {
    super(parent,[import19.RimSearchComponentNgFactory],[import19.RimSearchComponentNgFactory]);
  }
  get _LOCALE_ID_4():any {
    if ((this.__LOCALE_ID_4 == null)) { (this.__LOCALE_ID_4 = 'en-US'); }
  ...
  get _APP_ID_12():any {
    if ((this.__APP_ID_12 == null)) { (this.__APP_ID_12 = import20._appIdRandomProviderFactory()); }
  ...
  get _EventManager_16():import11.EventManager {
    if ((this.__EventManager_16 == null)) { (this.__EventManager_16 = new import11.EventManager(this._EVENT_MANAGER_PLUGINS_15,this.parent.get(import23.NgZone))); }
  ...
  get _RootRenderer_20():any {
    if ((this.__RootRenderer_20 == null)) { (this.__RootRenderer_20 = import24._createConditionalRootRenderer(this._DomRootRenderer_19,this.parent.get(import24.NgProbeToken,(null as any)))); }
  ...
  get _ViewUtils_23():import15.ViewUtils {
    if ((this.__ViewUtils_23 == null)) { (this.__ViewUtils_23 = new import15.ViewUtils(this._RootRenderer_20,this._Sanitizer_22)); }
    return this.__ViewUtils_23;
  }
  get _IterableDiffers_24():any {
    if ((this.__IterableDiffers_24 == null)) { (this.__IterableDiffers_24 = import3._iterableDiffersFactory()); }
    return this.__IterableDiffers_24;
  }
  get _KeyValueDiffers_25():any {
    if ((this.__KeyValueDiffers_25 == null)) { (this.__KeyValueDiffers_25 = import3._keyValueDiffersFactory()); }
    return this.__KeyValueDiffers_25;
  }
  get _SharedStylesHost_26():any {
    if ((this.__SharedStylesHost_26 == null)) { (this.__SharedStylesHost_26 = this._DomSharedStylesHost_17); }
  ...
  get _RimSearchService_28():import17.RimSearchService {
    if ((this.__RimSearchService_28 == null)) { (this.__RimSearchService_28 = new import17.RimSearchService()); }
    return this.__RimSearchService_28;
  }
  createInternal():import1.MainModule {
    ...
    this._ApplicationRef__9 = new import8.ApplicationRef_(this.parent.get(import23.NgZone),this.parent.get(import25.Console),this,this._ErrorHandler_6,this,this._ApplicationInitStatus_7,this.parent.get(import7.TestabilityRegistry,(null as any)),this._Testability_8);
  ...
  getInternal(token:any,notFoundResult:any):any {
    ...
    if ((token === import26.LOCALE_ID)) { return this._LOCALE_ID_4; }
    ...
    if ((token === import20.APP_ID)) { return this._APP_ID_12; }
    ...
    if ((token === import32.IterableDiffers)) { return this._IterableDiffers_24; }
    if ((token === import33.KeyValueDiffers)) { return this._KeyValueDiffers_25; }
    if ((token === import12.SharedStylesHost)) { return this._SharedStylesHost_26; }
    if ((token === import16.Title)) { return this._Title_27; }
    if ((token === import17.RimSearchService)) { return this._RimSearchService_28; }
